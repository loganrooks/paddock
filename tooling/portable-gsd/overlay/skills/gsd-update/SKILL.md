...
If the live issue is structural planning integrity rather than runtime/package movement, route to `$gsd-health`.

If runtime/package movement is already handled but the project still deserves broader repo-local posture refresh, route separately to `$gsd-uplift-project --write`.
</process>
