...
@/home/rookslog/workspace/projects/prix-guesser/.codex/get-shit-done/references/questioning.md
@/home/rookslog/workspace/projects/prix-guesser/.codex/get-shit-done/references/domain-probes.md
</required_reading>
...
| Seed | `$gsd-plant-seed` -> `.planning/seeds/SEED-NNN-slug.md` | Forward-looking ideas with trigger conditions |
...
- **Seeds:** Route through `$gsd-plant-seed` or the current `plant-seed` workflow so seed artifacts use the live `SEED-NNN-slug` contract with explicit `Why This Matters`, `trigger_when`, and `Strengthening Carry` carry instead of minting older ad hoc seed shapes inline
