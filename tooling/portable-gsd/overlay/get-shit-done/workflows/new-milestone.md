...
Do not clear `Future Carry Forward` just because a new milestone opened. Keep still-live preserved seams, keep-open non-decisions, posture assumptions, and seeded strengthening routes explicit until a later boundary closes or reroutes them.
...
- .planning/STATE.md (current Future Carry Forward digest when present)
- .planning/LONG-ARC.md (when present; future-shape doctrine to preserve while researching this milestone)
</files_to_read>
...
- .planning/STATE.md
- .planning/LONG-ARC.md (if exists)
...
6. Keep still-live Future Carry Forward items explicit in ROADMAP.md and STATE.md when they remain relevant after milestone opening
...
- [ ] LONG-ARC.md reread when present
- [ ] Future Carry Forward digest consumed when present
- [ ] MILESTONE-CONTEXT.md consumed and deleted (if existed)
- [ ] Research completed (if selected) — 4 parallel agents, milestone-aware
- [ ] Requirements gathered and scoped per category
- [ ] REQUIREMENTS.md created with REQ-IDs
- [ ] gsd-roadmapper spawned with phase numbering plus long-horizon carry context
