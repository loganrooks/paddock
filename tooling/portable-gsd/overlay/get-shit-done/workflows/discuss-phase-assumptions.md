...
- Source 2b: If `.planning/LONG-ARC.md` exists and materially constrains the phase, include it as a doctrine reference
...
[Preserve durable doctrine docs such as `.planning/LONG-ARC.md` when they actively constrain the phase; do not drop them just because they are project-level.]
