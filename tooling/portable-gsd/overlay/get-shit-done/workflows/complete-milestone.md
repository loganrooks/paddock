...
<step name="review_long_horizon_carry">

Before archival, project evolution, and final state cleanup, reread the long-horizon carry surfaces.

- Read `.planning/STATE.md`
- Read `.planning/LONG-ARC.md` when it exists
- If `STATE.md` carries `### Future Carry Forward`, review that digest explicitly before continuing

Use this review to decide what should stay explicit after milestone close:
- `Preserve:` still-live protected seams that should remain explicit into the next milestone
- `Keep open:` non-decisions that milestone close should not silently collapse
- `Posture:` posture assumptions or long-arc constraints that should remain explicit in `PROJECT.md` / `STATE.md`
...
7. **Long-horizon carry review:**
   - Compare the finished milestone against `.planning/LONG-ARC.md` when present
   - Review the current `Future Carry Forward` digest in `STATE.md`
   - Keep still-live preserved seams, keep-open decisions, posture assumptions, and seeded strengthening routes explicit instead of letting milestone close flatten them
...
- Keep still-live preserved seams explicit after milestone close
- Keep open non-decisions that remain active after milestone close
- Keep posture assumptions explicit when they still constrain later milestones
- Keep seeded strengthening routes explicit rather than letting them dissolve into retrospective prose
...
- [ ] LONG-ARC.md reviewed when present
- [ ] Future Carry Forward digest reviewed before archive and project evolution
...
- [ ] STATE.md keeps still-live future carry explicit after milestone close
