...
[Only keep still-live carry that should survive phase closure]

- Preserve: [seam that must remain open]
- Keep open: [non-decision that should stay explicit]
...
**Future Carry Forward:** Compact digest for planning carry that survives phase closure
- `Preserve:` for seams that should remain open
- `Keep open:` for non-decisions that should stay explicit
...
- Keep only still-live future-carry items; close or reroute the rest
