...
### Locked Decisions
[Copy from CONTEXT.md `## Implementation Decisions` section - these are NON-NEGOTIABLE]
- [Decision 1]
- [Decision 2]
...
### Resolved Questions
[Questions settled strongly enough for planning to treat as decided]

### Escalated Planning Obligations
[Questions planning must address explicitly through sequencing, validation, or task design]

### Preserved Non-Decisions
[Questions intentionally left open, with named reason they should remain open]

### Inconclusive Items
[What remains uncertain, with named consequence and recommended handling]
</research_disposition>
...
[Optional legacy/reader-facing section. If used, pair each item with a disposition in `## Research Disposition` rather than leaving bare unresolved questions here.]
...
- Core sections: user_constraints, research_disposition, summary, standard_stack, architecture_patterns, dont_hand_roll, common_pitfalls, code_examples, sources
- `research_disposition` is required whenever any question remains open, escalated, intentionally preserved, or inconclusive
...
- Research disposition: Never leave bare unresolved ambiguity when you can name the planning consequence instead

**Integration with planning:**
- RESEARCH.md loaded as @context reference in PLAN.md
- Research disposition tells the planner what is settled, what must be validated, and what should stay open
