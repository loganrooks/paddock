...
- **Should address**:
  ...
  - Merely adequate areas that leave the plan technically passable but weak for the repo's quality bar
- **Consider**:
...
| Concern | Reason |
|---------|--------|
| {concern} | {why the criticism was not accepted on the merits} |
```
