...
- [d:r:i] The broader propagation question is now also explicit:
  ...
  - the next bounded move is wider propagation mapping beyond the uplift example, unless a still-stronger local routing need appears first
...
- [o:r:i] Which broader producer / consumer and contract-carry families should widen next now that the uplift example also has an explicit overlay/materialization contract layer?
