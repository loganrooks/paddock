...
- [d:r:i] The broader propagation question is now also explicit:
  ...
  - the next bounded move is a challenge lane over that widened carrier split, unless a still-stronger local routing need appears first
...
- [o:r:i] What does a bounded challenge lane say about the widened carrier split in `08`: which carrier families are still missing, too coarse, or misplaced?
