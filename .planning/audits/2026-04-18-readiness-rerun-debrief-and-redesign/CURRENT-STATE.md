...
- [d:r:i] The broader contract-propagation / dependency-carry question is no longer only a seed concern. It is now an active governed family, but it is still at its local-opening stage rather than at an external challenge stage.
...
- [d:r:i] The broader propagation question is now also explicit:
  - now that the family is open, which producer / consumer and impact map should be written first
  - and which later external challenge should test whether contract changes ripple strongly enough across workflows, skills, scripts, outputs, registries, wrappers, and governing-doc carriers?
...
- [o:r:i] Which producer / consumer and impact map should open the new propagation-audit family most usefully?
