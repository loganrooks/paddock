...
- [d:r:i] The next adjacent move is now the `update` plus `gsd-update` consumer branch, with the small reference-side and contract-side sharpenings folded into that same slice before `from-gsd2` reopens afterward.
