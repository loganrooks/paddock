...
This subtree holds bounded challenge lanes about initialization, onboarding, re-entry, and project uplift as one entry-surface family.
...
For each lane, keep this tuple explicit:
...
- packet:
  - [packets/18-transition-state-uplift-continuity-first-slice-proposal-reread-packet.md](packets/18-transition-state-uplift-continuity-first-slice-proposal-reread-packet.md)
- spec:
  - [specs/12-transition-state-uplift-continuity-first-slice-proposal-reread-spec.md](specs/12-transition-state-uplift-continuity-first-slice-proposal-reread-spec.md)
- prompt:
  - [prompts/12-transition-state-uplift-continuity-first-slice-proposal-reread-opus47-max-r1-launch-prompt.md](prompts/12-transition-state-uplift-continuity-first-slice-proposal-reread-opus47-max-r1-launch-prompt.md)
- launch-truth:
...
- launch-truth:
  - [launch-truth/14-health-uplift-deepen-in-place-first-slice-proposal-reread-launch-truth.md](launch-truth/14-health-uplift-deepen-in-place-first-slice-proposal-reread-launch-truth.md)
- local inheritance:
...
- [d:r:i] Lane `16` is now completed and locally inherited:
  - [launch-truth/16-entry-runtime-continuity-shared-reference-proposal-reread-launch-truth.md](launch-truth/16-entry-runtime-continuity-shared-reference-proposal-reread-launch-truth.md)
  - [outputs/20-entry-runtime-continuity-shared-reference-proposal-reread-opus47-max-r1.md](outputs/20-entry-runtime-continuity-shared-reference-proposal-reread-opus47-max-r1.md)
...
- [d:r:i] Lane `17` is now completed and locally inherited:
  - [launch-truth/17-landed-entry-runtime-continuity-first-slice-reread-launch-truth.md](launch-truth/17-landed-entry-runtime-continuity-first-slice-reread-launch-truth.md)
  ...
  - [dispositions/21-landed-entry-runtime-continuity-first-slice-reread-inheritance.md](dispositions/21-landed-entry-runtime-continuity-first-slice-reread-inheritance.md)
- [d:r:i] Lane `18` is now completed and locally inherited:
  - [launch-truth/18-update-entry-runtime-continuity-follow-through-proposal-reread-launch-truth.md](launch-truth/18-update-entry-runtime-continuity-follow-through-proposal-reread-launch-truth.md)
  - [outputs/22-update-entry-runtime-continuity-follow-through-proposal-reread-opus47-max-r1.md](outputs/22-update-entry-runtime-continuity-follow-through-proposal-reread-opus47-max-r1.md)
  - [dispositions/22-update-entry-runtime-continuity-follow-through-proposal-reread-inheritance.md](dispositions/22-update-entry-runtime-continuity-follow-through-proposal-reread-inheritance.md)
