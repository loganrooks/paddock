...
- [d:r:i] The repo now has the first baseline/delta pair:
  ...
  - this artifact
- [d:r:i] The next adjacent move in this family should decide whether to:
  - widen the delta map a bit further
  - or start the bounded uplift agent-assist route that `93` still keeps explicit
