...
- [d:r:i] Current next move after this batch: use `79` through `86` plus `32` through `35` as the current seed-family baseline before any later wider entry-wrapper retrofit, broader audit-open consumer widening, or later rewrite/normalization family inherits next.
