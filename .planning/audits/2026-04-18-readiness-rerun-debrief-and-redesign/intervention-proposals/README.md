...
- [d:r:i] That `165` route is now opening under its own `parallelization-audit/` subtree so the diagnosis can carry packet/spec/prompt/launch-truth/output/inheritance artifacts without overloading `workspace-state-audit/`.
