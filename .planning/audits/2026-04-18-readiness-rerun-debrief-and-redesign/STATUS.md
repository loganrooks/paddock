...
- current governance-doc protocol status: `CURRENT-STATE.md is now the short governing synthesis, CURRENT-STATE-TRACE.md is the supporting cumulative trace, and GOVERNANCE-READING-AND-UPDATE-PROTOCOL.md now routes progressive disclosure and future governance-doc updates explicitly`
