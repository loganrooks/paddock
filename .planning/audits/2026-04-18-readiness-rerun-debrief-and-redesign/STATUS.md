...
- current live-only-agent-next-tranche status: `the remaining live-only agent contracts are still a real intervention surface, but the review/remediation/intel trio is no longer part of the unresolved cohort; gsd-code-reviewer, gsd-code-fixer, and gsd-intel-updater now carry through tracked overlay/runtime materialization and the next bounded authority/carry review moves to gsd-pattern-mapper`
- current high-leverage-authority-review status: `the first three bounded authority/carry reviews are now accepted at intervention-proposals/20-gsd-code-reviewer-authority-carry-review.md, intervention-proposals/21-gsd-code-fixer-authority-carry-review.md, and intervention-proposals/22-gsd-intel-updater-authority-carry-review.md; current next surface is gsd-pattern-mapper as the remaining authority-gap case`
...
4. revisit `gsd-pattern-mapper.toml` as the remaining authority-gap case, and decide whether it wants tracked carry or narrower routing/authority clarification
