...
- `lane-01-opus47-cross-review-disposition.md`
- `lane-02-opus47-max-resituation-review.md`
- the paired `OPUS-CORPUS-VOCABULARY-STRESS-TEST-SPEC.md` plus `lane-03-opus47-max-corpus-vocabulary-stress-test.md`
