...
- [e:c+i] The Wave-1 mapping output later found that the strongest live counter-evidence against `mapping is sufficient` was runtime-authority drift and the materialization chain, not broad-doc prose quality. Sources: [03-mapping-adequacy-and-comparative-mapping-opus47-max-r1.md](/home/rookslog/workspace/projects/prix-guesser/.planning/audits/2026-04-18-readiness-rerun-debrief-and-redesign/wave-1/outputs/03-mapping-adequacy-and-comparative-mapping-opus47-max-r1.md:15), [03-mapping-adequacy-and-comparative-mapping-opus47-max-r1.md](/home/rookslog/workspace/projects/prix-guesser/.planning/audits/2026-04-18-readiness-rerun-debrief-and-redesign/wave-1/outputs/03-mapping-adequacy-and-comparative-mapping-opus47-max-r1.md:109).
...
- [d:r:i] Do not spend another cycle pretending the active repo still needs a blind `latest install` just to know where it stands; the isolated probe already answered that question for `v1.38.1`.
- [g:r:i] The correct next sequence is:
  1. write the intervention-onboarding map from the now-completed three-way comparison: active local `v1.38.1` runtime, docs-refresh branch, and current upstream branch state
...
- [o:r:i] Which additions on current upstream `1.38.1` surfaces are direct candidates for repo-local harness intervention, and which are only docs/public-facing improvements?
...
- [o:r:i] Which local overlay patches or repo-local operating assumptions would silently flatten if the harness were later republished against a post-`1.38.1` upstream without a fresh isolated probe first?
