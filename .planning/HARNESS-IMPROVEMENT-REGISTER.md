...
- [d:r:i] Lifecycle carry follow-through beyond the current re-entry plus initialization/doc-ingest plus repair/migration plus update plus seed producer/consumer plus stale-producer-convergence slice
