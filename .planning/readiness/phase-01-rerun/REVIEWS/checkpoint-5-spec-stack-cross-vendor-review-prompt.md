# Checkpoint 5 Spec Stack Cross-Vendor Audit Prompt

Audit the current Checkpoint 5 candidate spec stack before any widened workflow or wrapper implementation lands.

This is a pre-implementation cross-vendor audit of scope, propagation, and hidden dependency handling. It is not permission to rewrite the checkpoint from scratch without justification.
