...
| 1 closure input | Pending | `docs(readiness): close checkpoint 1 and advance to checkpoint 2` | Should capture the Checkpoint 1 audit artifact, review artifact, and package-state transition into Checkpoint 2 |
