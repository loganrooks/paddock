...
| 1 support | Pending | `docs(readiness): add checkpoint 1 audit surface and spec` | Establish `AUDITS/` as the package-side home for reusable checkpoint audit specs and outputs before delegating the Checkpoint 1 authoring lane |
